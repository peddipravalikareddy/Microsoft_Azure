...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=(localdb)\\ProjectModels;Database=BikeStores;Trusted_Connection=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Brand>(entity =>
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27C51334DC");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B4E9B884E9");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85392FA3C1");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229D8500DAF");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4A6417098");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5EA27C8F1");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C5544C960");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164059B6B17").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D3892349CD");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C7D272397");
